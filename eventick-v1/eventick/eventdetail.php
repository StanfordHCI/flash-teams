                        ...
                        <div class="span9">
                            <div class="row-fluid">
                                <div class="span12" style="text-align:right;">
                                    <a href="#">edit</a>&nbsp;&nbsp;
                                    <a href="#" onClick="delEvent()">delete</a>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <div class="span6 tabbable"><!-- attendant and collaborator tabs -->
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#collaborator" data-toggle="tab">Collaborator</a></li>
                            </ul>
                                        ...
                                        <tbody>
                                            <?php $i=1; while ( $attendant = mysql_fetch_array( $attendant_sql ) ) { ?>
                                                <tr>
                                                    ...
                                                    <td class="span2" style="text-align:right;"><a href="#">plus</a>&nbsp;&nbsp;<a href="#">mail</a></td>
                                                </tr>
                                            <?php $i++;} ?>
                                        </tbody>
                                    </table>
