...
echo '<img src="img/na.gif" data-src="holder.js/300x200" alt="300x200" style="width: 300px; height: 200px;" >';echo '<div class="caption">';
...
echo ' <p>'.substr($row['Event_Details'], 0,30) .'...'.'</p>
				...
				{
					echo 	'<img src="img/check.png" /> <span style="color:green;">You are Attending</span><br/><a href="notattending.php?adv=advance&id='.$row['Event_ID'].'" style="color: red;" class="btn btn-secondary">Not Attending</a> ';
				}
				else
				{
				echo '<a href="attend.php?adv=advance&id='.$row['Event_ID'].'" class="btn btn-secondary">Attend</a> ';
				}
				if($row['IsFavorite']=='1')
				{
